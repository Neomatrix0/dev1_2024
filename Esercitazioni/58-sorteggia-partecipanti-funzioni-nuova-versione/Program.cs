...
class Program
{
    ...
    static void EliminaPartecipante()
    {
        ...
        .Title("SCEGLI PARTECIPANTE DA ELIMINARE")
        .PageSize(partecipanti.Count)
        .MoreChoicesText("[grey](Move up and down to reveal more)[/]")
        .AddChoices(partecipanti));     //prende i valori da partecipanti
       ...
       // Console.Write("Nome partecipante: ");
        ...
        if (partecipanti.Contains(inserimento))
        {
            partecipanti.Remove(inserimento);
            Console.WriteLine($"\nIl partecipante {inserimento} è stato eliminato dalla lista\n");
            SalvaPartecipanti();
            VisualizzaPartecipanti();
        }
        else
